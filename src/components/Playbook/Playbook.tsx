    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-slate-400 light:text-slate-500">
          The why behind the build order, and how to run the final stretch.
        </p>
      </div>

      <div className="glass-card p-5">
        <div className="mb-3 flex items-center gap-2 text-sm font-semibold text-purple-300 light:text-purple-700">
      ...
      <div className="glass-card p-5">
        <div className="mb-3 flex items-center gap-2 text-sm font-semibold text-cyan-300 light:text-cyan-700">
          <Compass className="h-4 w-4" /> Final 3 weeks — interview mode
        </div>
        <div className="markdown-body text-sm text-slate-300 light:text-slate-700 [&_strong]:text-cyan-300 light:[&_strong]:text-cyan-700">

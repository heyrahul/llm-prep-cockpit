...
export default function DrillCallout({ drill }: { drill: string }) {
  ...
  return (
    <div className="relative overflow-hidden rounded-2xl border border-amber-400/30 bg-gradient-to-br from-amber-500/10 via-transparent to-purple-500/10 p-5">
      ...
      <div className="markdown-body text-sm text-slate-200 light:text-slate-700 [&_strong]:text-amber-300">
      ...
      <div className="mt-4 flex items-center gap-4">
        ...
        <button
          ...
          className="flex items-center gap-1.5 rounded-lg bg-amber-500/20 px-3 py-1.5 text-xs font-semibold text-amber-200 hover:bg-amber-500/30"
        >
